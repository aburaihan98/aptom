...
export default function Banner() {
  return (
    <>
      <div className="bg-[#031e2d] relative overflow-hidden pb-[90px] md:pb-[180px] lg:pb-[300px] 2xl:pb-[500px]">
        {/* Left Image */}
        <div className="absolute -left-[29px] top-0">
          <img src={LeftImage} alt="Left Texture" className="h-full w-auto" />
        </div>
        {/* Right Image */}
        <div className="absolute -right-[29px] -top-[72px]">
          <img src={RightImage} alt="Right Texture" className="h-full w-auto" />
        </div>
        {/* navbar  */}
        <NavBar />

        <div className=" flex flex-col lg:flex-row lg:items-center justify-center lg:justify-between gap-6 text-white py-6 md:py-8 lg:py-16 xl:py-20 2xl:py-[120px] 2xl:px-[280px] mx-4 sm:mx-6 md:mx-12 lg:mx-16">
          {/* Content */}
          <div>
            <div className="flex items-center gap-2 lg:gap-2.5 mb-4 md:mb-5 lg:mb-6">
              <span className="w-3 h-3 bg-primary rounded-full"></span>
              <h3 className="font-medium">Turning complexity into clarity.</h3>
            </div>
      ...
      <div className="2xl:max-w-[1920px] 2xl:mx-auto flex justify-center mx-4 sm:mx-6 md:mx-12 lg:mx-16 2xl:mx-[100px] -translate-y-1/2 mx-4 sm:mx-6 md:mx-12 lg:mx-16 2xl:mx-[300px]">
